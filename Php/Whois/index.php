    ...
    <div class="form">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Whois</h4>
            </div>
            <div class="modal-body">
                <form action="<?=$_SERVER['PHP_SELF'];?>">
                    <label for="domain">Domain / IP Address</label>
                    <p></p>
                    <input class="form-control" type="text" name="domain" id="domain" value="<?=$domain;?>">
                    <p></p>
                    <input class="btn btn-success" type="submit" value="Lookup">
                </form>
            </div>
        </div>
    </div>
